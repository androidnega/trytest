    ...
    <div class="max-w-5xl mx-auto py-6 space-y-4">
        ...
        <div class="max-w-3xl">
            <section class="rounded-2xl border border-slate-200 bg-white p-5 space-y-3">
                ...
                <p class="text-xs text-slate-600"><strong>SQL practical:</strong> JSON uses <code class="rounded bg-slate-100 px-1">setup_sql</code>, <code class="rounded bg-slate-100 px-1">reference_sql</code> as the <strong>checking SELECT</strong> (rows compared — lenient overlap). For INSERT/DML answers, either add <code class="rounded bg-slate-100 px-1">golden_sql</code> (model statement), <em>or</em> put the model INSERT in <code class="rounded bg-slate-100 px-1">reference_sql</code> and the checking SELECT in <code class="rounded bg-slate-100 px-1">compare_sql</code> (alias <code class="rounded bg-slate-100 px-1">verify_sql</code>). Optional <code class="rounded bg-slate-100 px-1">hints</code>.</p>
