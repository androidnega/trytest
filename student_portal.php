...
<head>
    ...
    <link rel="stylesheet" href="<?php echo htmlspecialchars(trytest_url('assets/dashboard.css') . '?v=' . (string) (@filemtime(__DIR__ . '/assets/dashboard.css') ?: time()), ENT_QUOTES, 'UTF-8'); ?>">
    <style>
