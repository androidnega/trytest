...
<section id="section-quizzes" class="scroll-mt-20">
    <h2 class="mb-3 text-sm font-bold">Courses &amp; quizzes</h2>
    <?php if (!$coursesWithQuizzes): ?>
        <p class="rounded-xl border border-dashed border-slate-300 bg-white px-4 py-8 text-center text-sm text-slate-500">No courses match your level and program yet.</p>
    <?php else: ?>
        <div class="space-y-2">
